/*
Plugin used in both in both IMT web sites and CRM.
Contains only plugins for common needs :
- Fancybox2 : display a modal dialog
- Validation : validation rules when submitting a form
- Tooltip
Last update : 2012-10-01 Michael
*/
